...
ActiveRecord::Schema[7.0].define(version: 2025_02_07_095527) do
  ...
  create_table "transaction_entries", force: :cascade do |t|
    ...
    t.date "date"
    t.integer "recurring"
    t.index ["category_id"], name: "index_transaction_entries_on_category_id"
  ...
  add_foreign_key "transaction_entries", "categories"
